...
def start_timer():
    ...
    # count_down(300)
    # reps가 1/3/5/7 일때는 25분(WORK_MIN)
    # reps가 2/4/6 일때는 5분(SHORT_BREAK_MIN)
    # reps가 8 일때는 20분(LONG_BREAK_MIN)
    if reps == 9:
        reps = 1
...
# highlightthickness는 이미지의 경계선을 표시하는 옵셥이므로 0으로 설정하면 경계가 지워져 자연스러워진다.
